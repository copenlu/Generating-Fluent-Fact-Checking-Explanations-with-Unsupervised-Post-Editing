...
python run_sa.py --sentences_path /home/jolly/projects/COPE/FilteredData/sup_sccores_pubhealth/results_serialized_val_filtered.jsonl --dataset_path /home/jolly/projects/COPE/FilteredData/PUBHEALTH/dev.tsv --outfile pub_sup_val.txt --outdir pub_sup --batch_size 5 --device_type gpu --max_steps 220 --dataset_name pubhealth --length_weight 1.4 --fluency_weight 1.5 --semantic_weight_sentences 1.2 --reorder_th 0.94
...
python run_sa.py --sentences_path /home/jolly/projects/COPE/FilteredData/sup_sccores_pubhealth/results_serialized_test_filtered.jsonl --dataset_path /home/jolly/projects/COPE/FilteredData/PUBHEALTH/test.tsv --outfile pub_sup_test.txt --outdir pub_sup --batch_size 5 --device_type gpu --max_steps 220 --dataset_name pubhealth --length_weight 1.4 --fluency_weight 1.5 --semantic_weight_sentences 1.2 --reorder_th 0.94
...
python run_sa.py --sentences_path /home/jolly/projects/COPE/FilteredData/unsup_scores_pubhealth/results_serialized_val_filtered.jsonl --dataset_path /home/jolly/projects/COPE/FilteredData/PUBHEALTH/dev.tsv --outfile pub_unsup_val.txt --outdir pub_unsup --batch_size 5 --device_type gpu --max_steps 220 --dataset_name pubhealth --length_weight 1.4 --fluency_weight 1.5 --semantic_weight_sentences 1.2 --reorder_th 0.94
...
python run_sa.py --sentences_path /home/jolly/projects/COPE/FilteredData/unsup_sccores_pubhealth/results_serialized_test_filtered.jsonl --dataset_path /home/jolly/projects/COPE/FilteredData/PUBHEALTH/test.tsv --outfile pub_unsup_test.txt --outdir pub_unsup --batch_size 5 --device_type gpu --max_steps 220 --dataset_name pubhealth --length_weight 1.4 --fluency_weight 1.5 --semantic_weight_sentences 1.2 --reorder_th 0.94

echo "4. Running Pegasus Filtering for Un-supervised validation justifications!"
