...
python run_pegasus.py --sentences_path /home/jolly/projects/COPE/FilteredData/unsup_scores_liar/results_serialized_val_filtered.jsonl --dataset_path /home/jolly/projects/COPE/liar_data/ruling_oracles_val.tsv --outfile liar_unsup_val.txt --outdir liar_unsup --gold_path L_valgold_unsup.txt --outfile_filtered liar_unsup_val_filter.txt --device_type gpu --dataset_name liar
...
python run_pegasus.py --sentences_path /home/jolly/projects/COPE/FilteredData/unsup_scores_liar/results_serialized_test_filtered.jsonl --dataset_path /home/jolly/projects/COPE/liar_data/ruling_oracles_test.tsv --outfile liar_unsup_test.txt --outdir liar_unsup --gold_path L_testgold_unsup.txt --outfile_filtered liar_unsup_test_filter.txt --device_type gpu --dataset_name liar
