...
python run_pegasus.py --sentences_path /home/jolly/projects/COPE/FilteredData/unsup_scores_pubhealth/results_serialized_val_filtered.jsonl --dataset_path /home/jolly/projects/COPE/FilteredData/PUBHEALTH/dev.tsv --outfile pub_unsup_val.txt --outdir pub_unsup --gold_path P_valgold_unsup.txt --outfile_filtered pub_unsup_val_filter.txt --device_type gpu --dataset_name pubhealth
