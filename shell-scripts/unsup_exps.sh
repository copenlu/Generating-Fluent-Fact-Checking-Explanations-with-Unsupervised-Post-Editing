...
#############################
#Values copied from other shell scripts to prepare data other than hill climbing. We are using SA results already stored in iteration 1: (27.04.2021 to 03.05.2021) of google doc.  
#############################
